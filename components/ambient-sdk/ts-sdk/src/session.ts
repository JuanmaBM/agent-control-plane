...
export class SessionStatusPatchBuilder {
  ...
  sandboxLogsSnapshot(value: string): this {
    this.data['sandbox_logs_snapshot'] = value;
    return this;
  }

  sandboxPolicySnapshot(value: string): this {
    this.data['sandbox_policy_snapshot'] = value;
    return this;
  }
