...
**StopOnRunFinished** | Pointer to **bool** | When true, the sandbox is automatically terminated when the agent&#39;s task completes. When false, the sandbox remains running after the run finishes. | [optional] 
